...
// O
//아규먼트 없이 출력할 수 있다.
// a, b, c를 안 넣어도 기본 default값이 들어가 있다.
...
// O
// 함수를 그냥 호출하는 것이 아닌 할당이 안된 비어있는 {}를 안에 넣어서 object가 그대로 할당되도록 한다.
function 함수({a=10, b=20, c=30}){
    return a + b + c
}
함수({}) 
// 이 코드를 축소한 코드가 위의 코드입니다.
// 참고삼아서만 알아두세요.
...
// 재귀함수로만 풀어야 직관적인 코드들이 있다.
// 가독을 위해 채택하는 경우가 많다.
// 메모리 효율 측면에서는 반복문보다 좋지 않다고 본다.
